...
const Contact = () => {
  return (
    <>
      ...
      <section className="mt-10 flex flex-wrap justify-between sm:justify-around max-w-screen-lg mx-auto">
        <div className="flex justify-evenly flex-col mb-10 sm:mb-0">
        ...
        <div className="flex flex-col text-font-color">
          <h2 className="text-xl text-font-color-dark font-extrabold">
            Contact us directly:
          </h2>
          <input
            className="mt-4 p-2 border-primary-color border-[2px] border-solid"
          ...
          <textarea
            ...
            rows="5"
          ></textarea>
          <Button type="filled" classes="mt-4">
            Submit
          </Button>
        </div>
      </section>
